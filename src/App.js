...
const App = () => {
  ...
  const sendEmail = (e) => {
    ...
    const emailData = {
      ...
      mobile: formData.mobilenumberinput,
      subject: formData.emailSubjectinput,
  ...
  const onClickMenuLinks = () => {
    // This will be handled by the ModernNavigation component
  };

  const downloadResume = () => {
    const link = document.createElement('a');
    link.href = oneresume;
    link.download = 'Mohan_Reddy_Resume.pdf';
  ...
  return (
    <div className="initial-container">
      ...
      <ModernNavigation 
        ...
        onClickMenuLinks={onClickMenuLinks} 
      />

      <div className="main-container">
        {/* Enhanced Hero Section */}
        <div ref={homeRef}>
          <HeroSection profile={profile} downloadResume={downloadResume} />
        </div>
